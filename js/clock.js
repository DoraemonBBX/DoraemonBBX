...
// function active(){
//     var thisTop =find('.top.new');
//     var thisBottom =el.find('.bottom.new');
//     if(thisTop.offsetTop > thisTop.div.style.height){
//         thisBottom.style.opacity = "0";
//         el.find('.top.new .text').div.style.zIndex = '30';
//     }
//     thisTop.remove();
// }